    ...
    <div className="flex justify-between items-center w-3/4 md:w-full md:gap-7 pb-20 md:pb-0 animate">
      <Link
        ...
        <Image
          ...
          src={require('../../public/Images/YouTube.svg').default}
          alt="YouTube"
        />
      </Link>
      <Link
        ...
        <Image
          className="social-logos"
          src={require('../../public/Images/Instagram.svg').default}
          alt="Instagram"
        />
      </Link>
      <Link
        ...
        <Image
          className="social-logos"
          src={require('../../public/Images/TikTok.svg').default}
          alt="TikTok"
        />
      </Link>
      <Link
        ...
        <Image
          className="social-logos"
          src={require('../../public/Images/Facebook.svg').default}
          alt="Facebook"
        />
      </Link>
    </div>
